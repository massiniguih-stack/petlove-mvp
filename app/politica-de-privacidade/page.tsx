    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-4 py-10">
          ...
          <p className="mt-2 text-sm text-slate-500">Última atualização: janeiro de 2026</p>
          ...
          <div className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">3. Finalidade do tratamento</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">4. Compartilhamento de dados</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">5. Armazenamento e segurança</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">6. Seus direitos (LGPD)</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">7. Retenção de dados</h2>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900">8. Cookies e tecnologias</h2>
              <p className="mt-2">
