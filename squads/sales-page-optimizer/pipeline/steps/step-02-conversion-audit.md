---
execution: subagent
agent: carla-conversao
inputFile: squads/sales-page-optimizer/output/page-inventory.md
outputFile: squads/sales-page-optimizer/output/conversion-audit.md
model_tier: powerful
---
...
## Step-Specific Task
Faça auditoria de conversão com matriz impacto/esforço para landing, planos, cadastro tutor, cadastro parceiro e parceiro premium.
