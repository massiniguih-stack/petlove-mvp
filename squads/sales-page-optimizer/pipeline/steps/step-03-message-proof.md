...
execution: subagent
agent: paula-prova
inputFile: squads/sales-page-optimizer/output/conversion-audit.md
outputFile: squads/sales-page-optimizer/output/messaging-proof-map.md
model_tier: powerful
---
...
## Step-Specific Task
Mapeie objeções, prova, confiança, microcopy e riscos de promessa em cada etapa comercial.
